...
// klash ClientWorkerSearch
public class ClientWorkerSearch extends Thread {
    String category="";
    Pair<ArrayList<Room>> pair;
	private int REDUCERPORT;
	private String REDUCERHOST;

	// constructor gia ClientWorkerSearch
    public ClientWorkerSearch(String category, Pair<ArrayList<Room>> pair){
    ...
    public void run() {
		...
		try {
			...
			// apostolh ths kathgorias kai tou pair
